...
const EditCategory = () => {
    ...
    const fetchData = async () => {
      ...
      try {
        ...
        setErrors({
          ...
          imgtitle: photo || imgtitle ? validatePhotoTitle(imgtitle || "") : "",
  ...
  const handlePhotoChange = (e) => {
    ...
    setErrors(prev => ({
      ...
      imgtitle: file || currentPhoto ? validatePhotoTitle(imgtitle) : "",
    }));
  };
  ...
  const handleSubmit = async (e) => {
    ...
    const newErrors = {
      ...
      imgtitle: photo || currentPhoto ? validatePhotoTitle(imgtitle) : "",
      slug: validateSlug(slug),
      metatitle: validateMetaTitle(metatitle),
      metadescription: validateMetaDescription(metadescription),
      metakeywords: validateMetaKeywords(metakeywords),
    ...
    if (imgtitle) formData.append("imgtitle", imgtitle);
            ...
            <div className="mb-4">
              ...
              <input
                ...
                onChange={(e) => {
                  const value = e.target.value;
                  setImgtitle(value);
                  setErrors(prev => ({ ...prev, imgtitle: validatePhotoTitle(value) }));
                }}
