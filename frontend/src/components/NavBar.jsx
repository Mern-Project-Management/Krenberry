...
const Navbar = () => {
  ...
  return (
    <div className="w-full fixed z-30">
      <nav className="bg-white border-b border-gray-200 xl:mx-12 rounded-b-lg shadow-[#EC2127]/10 shadow-lg lg:block hidden">
        <div className="bg-[#0a0202] text-white text-center py-1  justify-center font-semibold text-xl text-md xl:flex hidden">
