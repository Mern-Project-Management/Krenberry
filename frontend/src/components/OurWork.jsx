  ...
  const ProjectCard = ({ project }) => {
    ...
    return (
      ...
      >
        ...
        <span className="project-button bg-white border border-red-600 text-gray-950 font-semibold text-sm rounded-full 
          py-2 px-6 shadow-lg hover:bg-green-200 transition-all duration-300 absolute bottom-0 mb-12 
