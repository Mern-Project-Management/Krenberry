...
const dummyServiceData = {
  heading: "<h2>Advanced Solutions</h2>",
  description: "<p>Transform your business with our cutting-edge solutions designed to drive growth and innovation. We leverage the latest technology and industry best practices to deliver exceptional results that exceed your expectations and help you stay ahead of the competition.</p>",
  questions: [
    {
      question: "How do you ensure quality delivery?",
      answer: "<p>We maintain strict quality standards through comprehensive testing, peer reviews, and continuous monitoring. Our quality assurance process ensures that every deliverable meets the highest standards and aligns with your specific requirements.</p>"
    },
    {
      question: "What is your implementation process?",
      answer: "<p>Our implementation follows a structured approach including discovery, planning, development, testing, and deployment phases. We maintain clear communication throughout and provide regular updates on progress and milestones.</p>"
    },
    {
      question: "Can you customize solutions for our needs?",
      answer: "<p>Absolutely! We specialize in creating tailored solutions that fit your unique business requirements. Our team works closely with you to understand your specific needs and develop customized approaches that deliver optimal results.</p>"
    },
    {
      question: "What kind of support do you provide?",
      answer: "<p>We offer comprehensive support including technical assistance, training, documentation, and ongoing maintenance. Our support team is available to help you maximize the value of your investment and ensure smooth operations.</p>"
    }
  ],
  photo: [placeholder]
};
...
export default function CraftLeft() {
  ...
  useEffect(() => {
    const fetchData = async () => {
      try {
        ...
        // Ensure data exists and has the expected structure - getting index [1] like original
        const data = response.data.data && response.data.data.length > 1 ? response.data.data[1] : null;
        console.log(data);
  ...
  // Use service data if available, otherwise fallback to dummy data
        ...
        <div className="w-full lg:w-[60%] px-4 flex flex-col justify-center order-1">
          ...
          <div className="max-w-full overflow-hidden">
            ...
            {service.heading ? (
              ...
              <h2 className="sm:text-4xl text-2xl font-bold pb-6">Advanced Solutions</h2>
            )}
          </div>
          ...
          <p className="mt-4 text-lg pb-4 text-justify">
            {service.description ? (
              ...
              "Transform your business with our cutting-edge solutions designed to drive growth and innovation. We leverage the latest technology and industry best practices to deliver exceptional results."
            )}
          </p>
